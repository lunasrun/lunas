...
exports.$$lunasCreateNonReactive = exports.$$lunasInitComponent = exports.valueObj = void 0;
...
const $$lunasInitComponent = function (args = {}, inputs = []) {
    ...
    const setImportVars = function (items) {
        for (const item of items) {
            ...
            else if ((0, reactivity_1.isReactive)(item)) {
                const { removeDependency } = item.addDependency(this, this.currentVarBitGen.next().value);
                this.resetDependecies.push(removeDependency);
            }
            else {
        ...
        for (const [getName, lunasElement, condition, postRender, ifCtxUnderFor, forCtx, depBit, [mapOffset, mapLength], [parentElementIndex, refElementIndex], fragments,] of ifBlocks) {
            ...
            this.ifBlocks[ifBlockId] = {
                renderer: ((mapOffset, _mapLength) => {
                    ...
                    postRender();
                    if (fragments) {
                        createFragments(fragments, indices, [...ifCtxUnderFor, ifBlockId], forCtx[forCtx.length - 1]);
                    }
    ...
    const insertTextNodes = function (args, _assignmentLocation = 0) {
        let assignmentLocation = typeof _assignmentLocation === "number"
            ? [_assignmentLocation]
            : _assignmentLocation;
    ...
    const createFragments = function (fragments, indices, ifCtx, latestForName) {
...
const _createDomElementFromLunasElement = function (lunasElement) {
...
function diffDetected(oldArray, newArray) {
    // return (
